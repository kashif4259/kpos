        ...
        <div class="modal-body scroll-modal app-bg-color p-3" v-show="hidePreLoader">
            <div class="form-row mx-0 mb-3 bg-white rounded p-3">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input v-model="supplier" id="supplier" class="form-control" placeholder="Supplier">
                </div>
            </div>
            
            <div class="form-row mx-0 mb-3 bg-white rounded p-3" v-if="!id">
                <div class="col-md-12 mb-3">
                    <h5 class="mb-0">Product Measurements</h5>
                </div>
                <div class="col-md-12">
                    <div class="">
                        ...
                        <input
                            ...
                            id="productLength"
                            value=""
                            v-model="product.productLength"
                        />
                        
                    </div>
                    <div class="">
                        <label class="" for="product_width">
                            Widht
                        </label>
                        <input
                            type="text"
                    ...
                    <div class="">&nbsp;</div>
                    <div class="">
                        <button type="button" @click="calculateQuantity" class="btn btn-primary app-color mobile-btn">Calculate Quantity</button> 
                    </div>
                </div>
            </div>
            ...
            <div v-if="!checkVariant" class="form-row mx-0 mb-3 bg-white rounded p-3">
                ...
                <div class="form-group col-md-4" v-if="initialQuantity == 1 && !id">
                ...
                <div class="form-group col-md-4" v-if="hideCommonInput">
                    <label>Compare Price 1</label>
                    <common-input
                        v-if="hidePreLoader"
                        name="compare_price1"
                        id="'standard-product-compare-price1'"
                        step="any"
                        :inputValue="decimalFormat(product.comparePrice1)"
                        @input="setComparePrice1"
                        :class="{ 'is-invalid':submitted && errors.has('comparePrice1') }"
                    ></common-input>
                </div>
                <div class="form-group col-md-4" v-if="hideCommonInput">
                    <label>Compare Price 2</label>
                    <common-input
                        v-if="hidePreLoader"
                        name="compare_price2"
                        id="'standard-product-compare-price2'"
                        step="any"
                        :inputValue="decimalFormat(product.comparePrice2)"
                        @input="setComparePrice2"
                        :class="{ 'is-invalid':submitted && errors.has('comparePrice2') }"
                    ></common-input>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        setComparePrice1(amount) {
            this.product.comparePrice1 = amount;
        },

        setComparePrice2(amount) {
            this.product.comparePrice2 = amount;
        },
        ...
        getEditData() {
            ...
            this.axiosGet(
                ...
                function(response) {
                    ...
                    instance.supplier = instance.productsInfo.productDetails.title;
                    ...
                    instance.product.comparePrice1 = instance.productsInfo.productDetails.compare_price1;
                    instance.product.comparePrice2 = instance.productsInfo.productDetails.compare_price2;
                    ...
                    if (
                        ...
                        // instance.product.comparePrice1 = 
                        //     instance.productsInfo.variantDetails[0].comparePrice1;
                        // instance.product.comparePrice2 = 
                        //     instance.productsInfo.variantDetails[0].comparePrice2;
                    } else {
                ...
                this.$validator.validateAll().then(result => {
                    if (
                        ...
                        if (instance.checkVariant) {
                            ...
                            instance.comparePrice1 = instance.pComparePrice1;
                            instance.comparePrice2 = instance.pComparePrice2;
                        } else {
                            ...
                            instance.comparePrice1 = instance.product.comparePrice1;
                            instance.comparePrice2 = instance.product.comparePrice2;
                        }
                        if (this.id) {
                            this.postDataMethod(
                                "/products/edit/" + instance.id,
                                {
                                    ...
                                    branch: 1,//instance.product.branch,
                                    ...
                                    productLength: instance.product.productLength,
                                    productWidth: instance.product.productWidth,
                                    comparePrice1: instance.product.comparePrice1,
                                    comparePrice2: instance.product.comparePrice2,
                            ...
                            this.postDataMethod("/products/store", {
                                ...
                                productLength: instance.product.productLength,
                                productWidth: instance.product.productWidth,
                                comparePrice1:instance.comparePrice1,
                                comparePrice2:instance.comparePrice2,
                                supplier: this.supplier
                            });
                        }
                    }
        ...
        calculateQuantity() {
            let instance = this;
            const width = instance.product.productWidth;
            const length = instance.product.productLength;
            if (!isNaN(width) && !isNaN(length)) {
                instance.standardProductQuantity = width * length;
            } else {
                instance.standardProductQuantity = null;
            }            
        }
    }
};
