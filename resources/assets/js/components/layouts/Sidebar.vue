<template>
    <div class="side-bar custom-scrollbar">
        <ul class="m-0">
            ...
            <li
                v-if="isReportActive"
                :class="{'active-side-bar': currentUrl == publicPath+'/product-reports', 'active-hover': isConnected || offline == 0}"
            >
                <a :href="publicPath+'/product-reports'" :class="{disabled:!isConnected && offline == 1}">
                    <i class="la la-pie-chart"></i>
