                ...
                <div class="horizontal-scroll">
                    ...
                    <div class="invoiceLogo text-center">
                        <img v-if="orderType === 'sales'"
                             :src="publicPath+'/images/new_logo.png'"
                    ...
                    <div>
                        ...
                        <div class="invoice-table">
                            <table class="table product-card-font" style="font-weight:500">
                                ...
                                <tr>
                                    <td class="cart-summary-table text-left"><b>Payment Method</b></td>
                                    <td class="cart-summary-table"></td>
                                    <td class="cart-summary-table"></td>
                                    <td class="cart-summary-table"></td>
                                    <td class="text-right cart-summary-table">{{ finalCart.custom_payment_type }}</td>
                                </tr>
                        ...
                        <div class="payment-action" id="js-payment-action">
                            <div class="row mx-0 mt-2 no-gutters">
                                <div class="col-12">
                                    ...
                                    <select id="custom-payment-method" class="form-control" v-model="finalCart.custom_payment_type">
                                        <option value="cash" selected="selected">Cash</option>
                                        <option value="Cheque">Cheque</option>
                                        <option value="credit-card">Credit Card</option>
                                        <option value="debit-card">Debit Card</option>
                                        <option value="split-payment">Split payment</option>
                                        <option v-if="orderType === 'sales'" value="bank-credit">Bank credit</option>
                                    </select>
...
export default {
    ...
    computed: {
        GetBtnTitle() {
            if(this.finalCart.currentUrl == "/receives"){
