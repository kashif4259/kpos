                ...
                <div class="form-row mx-0 px-2  collapse-animation"
                    ...
                    <!-- <div class="form-group pl-0 mb-zero" :class="[checkDiscount() ? 'col-4':'col-6']">
                        <label :for="'cart-item-room-length'+index" class="label-in-cart ">
                            Length</label>
                        <input type="text" :id="'cart-item-room-length'+index" class="form-control">
                    </div>
                    <div class="form-group pl-0 mb-zero" :class="[checkDiscount() ? 'col-4':'col-6']">
                        <label :for="'cart-item-room-width'+index" class="label-in-cart ">
                            Width</label>
                        <input type="text" :id="'cart-item-room-width'+index" class="form-control">
                    </div>
                    <div class="form-group pl-0 mb-zero" :class="[checkDiscount() ? 'col-4':'col-6']">
                        <label :for="'cart-item-room-fp'+index" class="label-in-cart">
                            Upload Floor Plan</label>
                        <input type="file" :id="'cart-item-room-fp'+index" accept="image/*" class="">
                    </div>
                    <div class="form-group pl-0 mb-zero" :class="[checkDiscount() ? 'col-4':'col-6']">
                        <label :for="'cart-item-area-type'+index" class="label-in-cart ">
                            Area Type</label>
                        <input type="text" :id="'cart-item-area-type'+index" class="form-control">
                    </div> -->
