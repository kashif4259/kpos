<template>
    <div class="data-table">
        ...
        <div class="main-table">
            <div class="lead text-center p-3" v-if="isBusy">
                Loading ...
            </div>
            <table v-else class="table">
                ...
                <tbody>
                        ...
                        <tr v-for="(data, key1) in tableData" :key="data.id" class="m-datatable__row" v-else>
                            ...
                            <td v-for="(value, key) in data">{{ changeDataValue(key,value) }}</td>
                        </tr>
                </tbody>
            </table>
        </div>
        <nav v-if="pagination && tableData.length > 0 && !isBusy">
            <ul class="pagination">
