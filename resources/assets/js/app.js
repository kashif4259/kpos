...
Vue.component('print-receipt-component', require('./components/salesOrReceives/invoice/PrintReceipt.vue'));
...
//Product Reports
Vue.component('product-reports', require('./components/productReports/product-reports.vue'));
Vue.component('datatable-profitLoss', require('./components/productReports/datatableProfitLoss.vue'));
Vue.component('datatable-inventory', require('./components/productReports/datatableInventory.vue'));
